...
# def parse_filelist_one_categories(filelist_path, split_char="|", categories=None):
#     with open(filelist_path, encoding='utf-8') as f:
#         filepaths_and_text = [line.strip().split(split_char) for line in f if categories in line]
#     return filepaths_and_text
